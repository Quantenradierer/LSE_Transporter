...
namespace LSE.Teleporter
{
    ...
    public class Teleporter : GameLogicComponent
    {
        ...
        public LSE.Control.ButtonControl<Sandbox.ModAPI.IMyOreDetector> Button;
        public LSE.Control.ControlAction<Sandbox.ModAPI.IMyOreDetector> ActionBeam;

        public ProfileListbox<Sandbox.ModAPI.IMyOreDetector> ProfileListbox;
        public Control.SwitchControl<Sandbox.ModAPI.IMyOreDetector> SwitchControl;
        public TargetCombobox<Sandbox.ModAPI.IMyOreDetector> TargetsListbox;
        public ProfileTextbox<Sandbox.ModAPI.IMyOreDetector> ProfileTextbox;

        public RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector> FilterOutrange;
        public RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector> FilterGPS;
        public RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector> FilterPlayers;
        public RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector> FilterTransporter;
        public RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector> FilterPlanets;
        ...
        */
        ...
        void CreateUI()
        {
            ...
            Button = new BeamButton<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "Beam",
                "Teleport");

            ProfileListbox = new ProfileListbox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "Profiles",
                "Profiles:",
                4);

            ProfileTextbox = new ProfileTextbox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity, "ProfileName", "Profile Name", "");

            SwitchControl = new FromSwitch<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "FromTo",
                "Transport from or to Target?",
                "From",
                "To");

            TargetsListbox = new TargetCombobox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "Targets",
                "Targets (+saved targets):",
                8);

            FilterOutrange = new RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "FilterOutrange",
                "Hide far targets ",
                true);

            FilterGPS = new RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "FilterGPS",
                "Hide GPS           ",
                false);

            FilterPlayers = new RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "FilterPlayers",
                "Hide Players      ",
                false);

            FilterTransporter = new RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "FilterTransporter",
                "Hide Transporter",
                false);

            FilterPlanets = new RefreshCheckbox<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
                "FilterPlanets",
                "Hide Planets      ",
                false);
            ...
            {
                ActionBeam = new ActivateProfileAction<Sandbox.ModAPI.IMyOreDetector>((IMyTerminalBlock)Entity,
